    ...
    <div className="relative w-full overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#0f1320] to-[#0a0d14]">
      ...
      <div className="absolute inset-0 flex items-end">
        <div className="p-4 sm:p-6">
          <p className="text-xs sm:text-sm text-white/70">Finicify</p>
          <h2 className="text-lg sm:text-2xl md:text-3xl font-semibold text-white">Modern Financial Analytics for B2B</h2>
        </div>
      </div>
    </div>
  )
